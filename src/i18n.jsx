...
const translations = {
    ja: {
        // Auth
        'auth.title': 'お帰りなさい',
        'auth.subtitle': '美しいAIワークスペースへようこそ',
        'auth.signUpTitle': 'アカウント作成',
        'auth.signUpSubtitle': 'AIワークスペースの世界へ',
        'auth.email': 'メールアドレス',
        'auth.password': 'パスワード',
        'auth.signIn': 'ログインする',
        'auth.signUpBtn': 'アカウントを登録',
        'auth.processing': '処理中...',
        'auth.needAccount': 'アカウントをお持ちでないですか？',
        'auth.alreadyHaveAccount': 'すでにアカウントをお持ちですか？',
        'auth.switchToSignUp': '新規登録はこちら',
        'auth.switchToSignIn': 'ログインはこちら',
        'auth.footer': 'Powered by Supabase Auth',
        'auth.checkEmail': '確認メールを送信しました！',
        'auth.unexpectedError': '予期せぬエラーが発生しました。',
        'auth.noSupabase': 'エラー: Supabaseが設定されていません。',
        'auth.sutejpHint': 'テスト用メールアドレスが必要な場合は',
        'auth.sutejpLink': 'sute.jpを開く',
    ...
    en: {
        ...
        'auth.subtitle': 'Enter your beautiful AI workspace',
        'auth.signUpTitle': 'Create Account',
        'auth.signUpSubtitle': 'Join the AI workspace',
        'auth.email': 'Email',
        ...
        'auth.noSupabase': 'Error: Supabase is not configured.',
        'auth.sutejpHint': 'Need a disposable email? Try',
        'auth.sutejpLink': 'sute.jp',
    ...
    zh: {
        'auth.title': '欢迎回来',
        'auth.subtitle': '进入您美丽的AI工作区',
        'auth.signUpTitle': '创建账户',
        'auth.signUpSubtitle': '加入AI工作区',
        'auth.email': '邮箱',
        'auth.password': '密码',
        'auth.signIn': '登录',
        'auth.signUpBtn': '注册新账号',
        'auth.processing': '处理中...',
        'auth.needAccount': '还没有账号？',
        'auth.alreadyHaveAccount': '已有账号？',
        'auth.switchToSignUp': '点击注册',
        'auth.switchToSignIn': '点击登录',
        'auth.footer': 'Powered by Supabase Auth',
        'auth.checkEmail': '请检查您的邮箱以确认！',
        'auth.unexpectedError': '发生了意外错误。',
        'auth.noSupabase': '错误：Supabase未配置。',
        'auth.sutejpHint': '需要临时邮箱？访问',
        'auth.sutejpLink': 'sute.jp',
