...
const translations = {
    ja: {
        ...
        'sidebar.newSpace': '新規スペース',
        'sidebar.history': '履歴',
        'sidebar.loading': '読み込み中...',
        'sidebar.empty': 'スペースがありません',
        ...
        'chat.empty': 'チャットを始めましょう。ここでの会話はノード内部に保存されます。',
